...
const details = {
  Resources: [
    ...
    { name: 'Antdv Next', url: 'https://antdv-next.com/' },
    { name: 'Antdv Next X', url: 'https://x.antdv-next.com/' },
  ],
  Community: [
    { name: 'Change Log', url: 'https://github.com/antdv-next/antdv-next-pro/releases' },
    { name: 'Bug Report', url: 'https://github.com/antdv-next/antdv-next-pro/issues' },
  ],
  Links: [
